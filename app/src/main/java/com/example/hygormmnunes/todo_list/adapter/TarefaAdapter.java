package com.example.hygormmnunes.todo_list.adapter;
...
import com.example.hygormmnunes.todo_list.R;
...
public class TarefaAdapter extends ArrayAdapter<Tarefa> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listaItem == null){
            listaItem = LayoutInflater.from(context).inflate(R.layout.layout_lista_tarefas,
                    parent, false);
        ...
        TextView textViewDescricao = listaItem.findViewById(R.id.textViewDescricao);
        textViewNome.setText(tarefaAtual.getNome());
        textViewStatus.setText(tarefaAtual.getStatus().toString());
        textViewDescricao.setText(tarefaAtual.getDescricao());
